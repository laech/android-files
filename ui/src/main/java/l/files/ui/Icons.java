...
import static l.files.ui.R.string.ic_dir;
import static l.files.ui.R.string.ic_dir_device;
import static l.files.ui.R.string.ic_dir_download;
import static l.files.ui.R.string.ic_dir_home;
import static l.files.ui.R.string.ic_dir_image;
import static l.files.ui.R.string.ic_dir_music;
import static l.files.ui.R.string.ic_dir_video;
import static l.files.ui.R.string.ic_file;
import static l.files.ui.R.string.ic_file_archive;
import static l.files.ui.R.string.ic_file_image;
import static l.files.ui.R.string.ic_file_music;
import static l.files.ui.R.string.ic_file_pdf;
import static l.files.ui.R.string.ic_file_text;
import static l.files.ui.R.string.ic_file_video;
