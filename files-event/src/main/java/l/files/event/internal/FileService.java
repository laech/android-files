...
public abstract class FileService extends IntentService {
    ...
    static abstract class CutOrCopy extends FileService {
        @Override
        protected final void handle(Intent intent) throws IOException {
    ...
    public static final class Cut extends CutOrCopy {
        @Override
        protected void handle(File from, File to) throws IOException {
            if (from.isDirectory()) {
    ...
    public static final class Copy extends CutOrCopy {
        @Override
        protected void handle(File from, File to) throws IOException {
            FileOperation.newCopy(from, to).execute();
        }
    }

    public static final class Delete extends FileService {
        @Override
        protected void handle(Intent intent) throws IOException {
