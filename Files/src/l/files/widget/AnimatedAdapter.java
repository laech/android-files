...
import static l.files.animation.Animations.*;
import static l.files.util.Sets.difference;
import static l.files.widget.ListViews.getFirstChildScrollOffset;
import static l.files.widget.ListViews.getVisibleItems;
