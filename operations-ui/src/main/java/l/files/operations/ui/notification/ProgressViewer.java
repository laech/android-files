...
abstract class ProgressViewer<T extends ProgressInfo> implements NotificationViewer<T> {
    ...
    @Override
    public final String getContentTitle(T value) {
    ...
    @Override
    public final String getContentText(T value) {
    ...
    @Override
    public final String getContentInfo(T value) {
    ...
    @Override
    public final float getProgress(T value) {
