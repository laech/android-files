...
public final class FileView extends View implements Drawable.Callback {
    ...
    public void set(FileTextLayouts layouts, FileInfo item, int textWidth, Rect size) {
    ...
    public void set(FileTextLayouts layouts, FileInfo item, int textWidth, Bitmap bitmap) {
