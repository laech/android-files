...
void Java_l_files_fs_local_Stdio_rename(JNIEnv *env, jclass clazz, jstring jold, jstring jnew) {
...
void Java_l_files_fs_local_Stdio_remove(JNIEnv *env, jclass clazz, jstring jpath) {
