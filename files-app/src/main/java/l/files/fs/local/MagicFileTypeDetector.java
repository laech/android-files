...
/**
 * Detects by looking at the file's magic number. Therefore this detector will
 * need to read the file's header.
 */
final class MagicFileTypeDetector extends LocalFileTypeDetector {

  private static final MagicFileTypeDetector INSTANCE = new MagicFileTypeDetector();
