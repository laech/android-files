...
package l.files.fs.local.android.os;
...
/*
 * This is a copy of android.os.FileObserver,
 * because testing found that on HTC One M8, the FileObserver appears
 * to be have a different implementation (even though couldn't find
 * the source code for it), which causes deadlocks quite frequently when
 * running the tests.
 */
...
public abstract class FileObserver {
    ...
    private static class ObserverThread extends Thread {
        private final HashMap<Integer, WeakReference> m_observers = new HashMap<>();
        private int m_fd;
