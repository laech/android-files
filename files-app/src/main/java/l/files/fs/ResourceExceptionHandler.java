...
public interface ResourceExceptionHandler {
     ...
     * {@link ResourceVisitor#accept(Resource)} throws an IOException. Any
     * exception thrown from this method will terminate the traversal the
     * exception itself will be propagated through, if no exception is thrown
