...
public final class NameTest extends TestCase
{
    ...
    private void testBaseDotExt(final String value)
    {
        final Name name = Name.of(value);
        assertEquals(value, name.base() + name.dotExt());
    }

    private void testNameHasBase(final String name, final String base)
    {
        assertEquals(base, Name.of(name).base());
    }

    private void testNameHasExt(final String name, final String ext)
    {
    ...
    private void testSort(final Locale locale, final String... names)
    {
        final List<Name> expected = names(names);
        final List<Name> actual = new ArrayList<>(expected);
    ...
    private List<Name> names(final String... names)
    {
        final List<Name> result = new ArrayList<>(names.length);
