...
import static com.example.files.animation.Animations.listItemRemoval;
...
public final class ListViews {
  ...
  static void removeItems(final ListView list, final ArrayAdapter<?> adapter, final List<Object> items) {
